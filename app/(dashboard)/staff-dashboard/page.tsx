...
export default function StaffDashboardPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] px-1 py-4 text-zinc-950 sm:px-6 sm:py-6 dark:text-zinc-100">
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        <section className="overflow-hidden rounded-[30px] border border-white/70 bg-white/90 shadow-[0_30px_80px_rgba(15,23,42,0.10)] backdrop-blur dark:border-black dark:bg-zinc-950/85 dark:shadow-[0_30px_80px_rgba(0,0,0,0.45)]">
          <div className="grid gap-6 p-4 sm:p-8 lg:grid-cols-[1.35fr_0.85fr]">
            <div className="min-w-0 space-y-5">
              ...
              <div className="space-y-3">
                <h1 className="break-words text-[2rem] font-semibold leading-tight tracking-tight text-zinc-950 min-[360px]:text-3xl sm:text-4xl dark:text-zinc-50">
              ...
              <div className="grid grid-cols-2 gap-3 sm:flex sm:flex-wrap">
                <Link
                  href="/my-attendance"
                  className="inline-flex min-w-0 items-center justify-center gap-2 rounded-2xl border border-zinc-200 bg-zinc-950 px-3 py-2.5 text-sm font-semibold text-white transition hover:bg-zinc-800 sm:px-4 dark:border-black dark:bg-black dark:text-white dark:hover:bg-zinc-950"
                >
                ...
                <Link
                  href="/profile"
                  className="inline-flex min-w-0 items-center justify-center gap-2 rounded-2xl border border-zinc-200 bg-white px-3 py-2.5 text-sm font-semibold text-zinc-700 transition hover:bg-zinc-50 sm:px-4 dark:border-black dark:bg-black dark:text-white dark:hover:bg-zinc-950"
                >
            ...
            <div className="min-w-0 rounded-[24px] border border-zinc-200/70 bg-white p-4 text-zinc-950 shadow-[0_20px_50px_rgba(15,23,42,0.10)] sm:p-5 dark:border-black dark:bg-gradient-to-br dark:from-zinc-950 dark:via-zinc-900 dark:to-indigo-950 dark:text-white dark:shadow-[0_20px_50px_rgba(0,0,0,0.35)]">
